<template>
    <section id="properties-carousel" class="properties-carousel pt-90 pb-90">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="carousel carousel-dots" :data-slide="dataSlide" data-slide-rs="2" data-autoplay="true" data-nav="false" data-dots="true" data-space="25" data-loop="true" data-speed="800">
                            <!-- .property-item #1 -->
...
export default {
    ...
    computed : {
        dataSlide(){
            return this.properties.length >= 3 ? 3 : 2  
        }
    }
}
</script>
