                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8">
                        <div class="row">
                            ...
                            <div class="properties properties-list">
                                ...
                                <img :src="properties[0].media.photos" alt="property image" class="img-responsive">
								</a>
                                            <span class="property--status">For {{properties[0].description.status}}</span>
                                        </div>
                                        <div class="property--content">
                                            <div class="property--info">
                                                <h5 class="property--title"><a href="property-single-gallery.html">{{properties[0].name}}</a></h5>
                                                <p class="property--location">{{properties[0].location.address}}</p>
                                                <p class="property--price">${{properties[0].price}}</p>
                                            </div>
                                            <!-- .property-info end -->
                                            <div class="property--features">
                                                <ul class="list-unstyled mb-0">
                                                    <li><span class="feature">Beds:</span><span class="feature-num">{{properties[0].description.bedrooms}}</span></li>
                                                    <li><span class="feature">Baths:</span><span class="feature-num">{{properties[0].description.bathrooms}}</span></li>
                                                    <li><span class="feature">Area:</span><span class="feature-num">{{properties[0].description.area}} sq ft</span></li>
                                                </ul>
                                            </div>
